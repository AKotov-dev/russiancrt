...
* После перехода на системное хранилище **необходимо удалить импортированные ранее сертификаты** и перезапустить Firefox. Теперь он их будет читать автоматически.
...
### Архивная информация (общий порядок установки оригинальных сертификатов)
