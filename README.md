...
Все последующие обновления сертификатов в рамках данного пакета также будут обрабатываться с помощью [этого](https://habr.com/ru/articles/1071256/) механизма.  
