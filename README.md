...
* После перехода на системное хранилище **необходимо удалить импортированные ранее сертификаты** (ещё раз), полностью очистить историю и перезапустить Firefox. Теперь он будет читать их автоматически.
