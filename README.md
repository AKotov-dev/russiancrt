...
* После перехода на системное хранилище **необходимо удалить импортированные ранее сертификаты** (ещё раз), очистить историю/кеш и перезапустить Firefox. Теперь он будет читать их автоматически.
